...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://jordanfight-819a4.firebaseio.com"),
    
    refUser = new Firebase("https://jordanfight-819a4.firebaseio.com/users"),
 
    refMenu = new Firebase("https://jordanfight-819a4.firebaseio.com/buses");
	 refMenu2 = new Firebase("https://jordanfight-819a4.firebaseio.com/passengers");
  return {
    ref: function() {
      return ref;
    },
